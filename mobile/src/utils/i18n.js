...
const T = {
  en: {
    ...
    release_confirm_fee_body_1: 'Releasing this maid is always free.',
    release_confirm_fee_body_2_prefix: 'However, to start chatting or hiring a new maid you must first pay a replacement fee of',
    release_confirm_fee_body_2_suffix: 'You have 3 days to complete your replacement.',
    // Toast after release
  ...
  ar: {
    ...
    vacancy_released: 'تم إخلاء الشاغر',
    release_failed: 'فشل الإخلاء',
    release_btn: 'إخلاء',
    release_dialog_title: '↩ إخلاء العاملة',
    release_confirm_grace_body_1: 'أنت في فترة السماح (3 أيام). الإخلاء مجاني تماماً.',
    release_confirm_grace_body_2: 'التوظيف التالي مجاني أيضاً. لديك 3 أيام لاختيار بديلة.',
    release_confirm_fee_body_1: 'الإخلاء دائماً مجاني.',
    release_confirm_fee_body_2_prefix: 'لكن لبدء المحادثة أو توظيف عاملة جديدة، يجب دفع رسوم الاستبدال البالغة',
    release_confirm_fee_body_2_suffix: 'لديك 3 أيام لإتمام الاستبدال.',
    release_toast_free: 'نافذة الاستبدال المجاني لمدة 3 أيام نشطة الآن.',
    release_toast_fee_prefix: 'ادفع',
    release_toast_fee_suffix: 'لفتح المحادثة مع عاملتك القادمة.',
  },
  ...
  fr: {
    ...
    release_confirm_fee_body_1: 'La libération est toujours gratuite.',
    release_confirm_fee_body_2_prefix: 'Cependant, pour démarrer une conversation ou embaucher, vous devez d\'abord payer des frais de remplacement de',
    release_confirm_fee_body_2_suffix: 'Vous avez 3 jours pour finaliser le remplacement.',
  ...
  ha: {
    ...
    release_confirm_fee_body_1: 'Sakin ma\'aikaciya kyauta ne koyaushe.',
    release_confirm_fee_body_2_prefix: 'Amma don fara tattaunawa ko ɗaukar sabuwar ma\'aikaciya, dole ne ku biya kuɗin maye gurbi na',
    release_confirm_fee_body_2_suffix: 'Kuna da kwanaki 3 don kammala maye gurbi.',
