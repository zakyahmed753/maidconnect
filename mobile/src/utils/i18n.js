...
const T = {
  ...
  ar: {
    ...
    plan_active_listing: 'ملفك الشخصي يظهر للعائلات الباحثة عن عاملة',
    plan_photos: 'أضيفي حتى 5 صور لتبرزي أمام العملاء',
    plan_chat: 'تواصلي مباشرة مع العائلات المهتمة في أي وقت',
    plan_analytics: 'اعرفي كم عائلة اطلعت على ملفك الشخصي',
    plan_support: 'اقبلي حتى طلبَي توظيف في الشهر',
    ...
    release_confirm_fee_body_1: '⚠ يجب دفع رسوم الاستبدال قبل أن تتمكني من المحادثة أو توظيف عاملة جديدة.',
    release_confirm_fee_body_2_prefix: 'قيمة الرسوم:',
    release_confirm_fee_body_2_suffix: 'يجب سداد هذه الرسوم قبل بدء أي محادثة أو طلب توظيف.',
